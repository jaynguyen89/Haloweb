...
const english: ITranslation = {
    translation: {
        ...
        'activate-account-page': {
            ...
            'request-to-get-secret-code-no-pending-activation-found': 'Invalid data `{{destination}}: no account with such data to be activated.`',
            ...
            'activate-account-response-error-400': 'Your request to activate account was unable to be processed due to missing account information.',
            'activate-account-response-error-409-by-secret-code': 'Your request to activate account was failed due to mismatched secret code.',
            'activate-account-response-error-409-by-activation-token': 'Your request to activate account was failed due to mismatched activation token.',
            'activate-account-response-error-410': 'Your request to activate account was failed because secret code has expired. Please reload page to restart the activation process.',
            'activate-account-response-error-416': 'Your request to activate account was unable to be processed due to invalid token type.',
