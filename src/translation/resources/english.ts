    ...
    translation: {
        ...
        'profile-page': {
            'profile-details': {
                ...
                'website-none': 'You haven\'t added any websites yet.',
                'modal-create': 'Add website link',
                'modal-update': 'Update website link',
                'modal-link-type': 'Link Type',
                'modal-link-text': 'Link URL',
                'modal-link-error': 'The link URL seems to be invalid.',
                'modal-link-duplicate': 'The link URL is redundant with an existing one.',
            ...
            'address-book': {
                ...
                'modal-create': 'Add new address',
                'modal-update': 'Update address',
                'delete-address-confirmation': 'This action can\'t be undone. Are you sure to delete this address?\n\n{{address}}',
                'address-form': {
                    'variant-radio-label': 'Address variant',
                    'variant-eastern': 'Eastern format',
                    'variant-western': 'Western format',
                    'building-name-label': 'Building name',
                    'po-box-label': 'PO Box number',
